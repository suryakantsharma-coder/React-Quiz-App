        ...
        <div>
            ...
            <div className="root">
                <div className="aboutMe_Section">
                    ...
                    <p style={{ fontFamily: "'Style Script', cursive", fontSize: "3.5vh" }}>My Name Is Surya Kant Sharma. I'm an Android and Web App Developer. I work on various projects in Android and Web Applications.
                        ...
                        I'm also Working with ML Services, Cloud, and Cloud Messages.
                    </p>
                </div>
